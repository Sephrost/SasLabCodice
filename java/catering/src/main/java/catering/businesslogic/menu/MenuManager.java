...
public class MenuManager {
    ...
    public Menu createMenu(String title) throws UseCaseLogicException {
        ...
        if (!user.isChef()) {
            throw new UseCaseLogicException("errore x");
        }
    ...
    public MenuItem insertItem(KitchenJob kj, Section sec, String desc) throws UseCaseLogicException {
        if (this.currentMenu == null) throw new UseCaseLogicException("errore x");
        if (sec != null && this.currentMenu.getSectionPosition(sec) < 0) throw new UseCaseLogicException("errore x");
        MenuItem mi = this.currentMenu.addItem(kj, sec, desc);
        this.notifyMenuItemAdded(mi);
        return mi;
    }

    public MenuItem insertItem(KitchenJob kj, Section sec) throws UseCaseLogicException {
        return this.insertItem(kj, sec, kj.getName());
    }

    public MenuItem insertItem(KitchenJob kj) throws UseCaseLogicException {
        return this.insertItem(kj, null, kj.getName());
    }

    public MenuItem insertItem(KitchenJob kj, String desc) throws UseCaseLogicException {
        return this.insertItem(kj, null, desc);
    }

    public void setAdditionalFeatures(String[] features, boolean[] values) throws UseCaseLogicException {
        if (this.currentMenu == null) throw new UseCaseLogicException("errore x");
        if (features.length != values.length) throw new UseCaseLogicException("errore x");
    ...
    public void changeTitle(String title) throws UseCaseLogicException {
        if (currentMenu == null) throw new UseCaseLogicException("errore x");
    ...
    public void deleteMenu(Menu m) throws UseCaseLogicException, MenuException {
        ...
        if (!u.isChef()) throw new UseCaseLogicException("errore x");
        if (m.isInUse() || !m.isOwner(u)) {
            throw new MenuException("errore y");
        }
    ...
    public void deleteSection(Section s, boolean deleteItems) throws UseCaseLogicException {
        if (currentMenu == null || currentMenu.getSectionPosition(s) < 0) throw new UseCaseLogicException("errore x");
    ...
    public void moveSection(Section sec, int position) throws UseCaseLogicException {
        if (currentMenu == null || currentMenu.getSectionPosition(sec) < 0) throw new UseCaseLogicException("errore x");
    ...
    public void moveMenuItem(MenuItem mi, Section sec, int position) throws UseCaseLogicException {
        if (sec == null) {
            if (currentMenu == null || currentMenu.getFreeItemPosition(mi) < 0) throw new UseCaseLogicException("errore x");
    ...
    public void assignItemToSection(MenuItem mi, Section sec) throws UseCaseLogicException {
        ...
        if (sec != null && currentMenu.getSectionPosition(sec) < 0) throw new UseCaseLogicException("errore x");

        // l'item deve appartenere al menu, o in una sezione o come voce libera
        Section oldsec = currentMenu.getSectionForItem(mi);
        if (oldsec == null && currentMenu.getFreeItemPosition(mi) < 0) throw  new UseCaseLogicException("errore x");
    ...
    public void editMenuItemDescription(MenuItem mi, String desc) throws UseCaseLogicException {
        if (currentMenu == null) throw new UseCaseLogicException("errore x");
        if (currentMenu.getSectionForItem(mi) == null && currentMenu.getFreeItemPosition(mi) < 0) throw new UseCaseLogicException("errore x");
